...
void cScenarioTrain::ParseArgs(const std::shared_ptr<cArgParser>& parser)
{
	...
	if (succ)
	{
		...
		mNetFiles[cTerrainRLCtrlFactory::eNetFileActorSolver] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActorSolver];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticSolver] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticSolver];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Solver] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Solver];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Solver] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Solver];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileActorModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActorModel];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticModel];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Model] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Model];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Model] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Model];

		mNetFiles[cTerrainRLCtrlFactory::eNetFileActorTerrainModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActorTerrainModel];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileActorActionModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileActorActionModel];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticTerrainModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticTerrainModel];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticValueModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticValueModel];

		mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamics] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamics];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsSolver] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsSolver];
		mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsModel] = fpath + mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsModel];
