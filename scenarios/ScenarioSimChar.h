...
public:
	...
	virtual bool EnabledRecording() const;
	virtual void EnableMotionRecording(bool enable);
...
protected:
	...
	cMotionRecorder mMotionRecorder;
	...
	virtual void EndRecordMotion();
	virtual void OutputMotionRecord(const std::string& out_file) const;
};
